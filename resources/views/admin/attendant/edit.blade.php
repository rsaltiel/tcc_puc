...
<ol class="breadcrumb">
    ...
    <li class="{{ route('attendant.index') }}"> Editar Atendente</li>
</ol>
<div class="callout callout-info">
    <p>Altere os dados necessários do atendente.</p>
</div>
...
<div class="box box-info">
    ...
    <form class="form-horizontal" action="{{ route('attendant.update', ['attendant' => $attendant->id]) }}" method="POST">
