...
<ol class="breadcrumb">
    ...
    <li class="{{ route('speciality.index') }}"> Editar Especialidade</li>
</ol>
<div class="callout callout-info">
    <p>Altere os dados necessários da especialidade.</p>
</div>
...
<div class="box box-info">
    ...
    <form class="form-horizontal" action="{{ route('speciality.update', ['speciality' => $speciality->id]) }}" method="POST">
